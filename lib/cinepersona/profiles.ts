  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Three directors whose work pays back a re-watch: Wong Kar-wai, Yorgos Lanthimos, Guillermo del Toro. Five films that pair a wide audience with a deep undertow: In the Mood for Love, Pan's Labyrinth, The Banshees of Inisherin, Eternal Sunshine of the Spotless Mind, Whiplash. Tags they live in: slow-burn poetry, haunting symbolism, auteur drama.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "director", title: "Guillermo del Toro" },
      { kind: "film", title: "In the Mood for Love", year: 2000 },
      { kind: "film", title: "Pan's Labyrinth", year: 2006 },
      { kind: "film", title: "The Banshees of Inisherin", year: 2022 },
      { kind: "film", title: "Eternal Sunshine of the Spotless Mind", year: 2004 },
      { kind: "film", title: "Whiplash", year: 2014 },
      { kind: "genre", title: "slow-burn poetry" },
      { kind: "genre", title: "haunting symbolism" },
      { kind: "genre", title: "auteur drama" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three auteurs they stumble into and stay with: Wes Anderson, Sofia Coppola, Hirokazu Kore-eda. Five films they'd open without quite knowing why: Lost in Translation, The Grand Budapest Hotel, Past Lives, Drive My Car, Shoplifters. Tags they live in: wandering art-house, melancholic mood, drifting symbolism.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "The Grand Budapest Hotel", year: 2014 },
      { kind: "film", title: "Past Lives", year: 2023 },
      { kind: "film", title: "Drive My Car", year: 2021 },
      { kind: "film", title: "Shoplifters", year: 2018 },
      { kind: "genre", title: "wandering art-house" },
      { kind: "genre", title: "melancholic mood" },
      { kind: "genre", title: "drifting symbolism" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors at the centre of any film-school syllabus: Stanley Kubrick, Akira Kurosawa, Martin Scorsese. Five films that almost everyone has heard of and few have fully read: 2001: A Space Odyssey, The Godfather, Seven Samurai, Goodfellas, Apocalypse Now. Tags they live in: canonical heavyweights, cinema-as-syllabus, modernist mastery.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "director", title: "Martin Scorsese" },
      ...
      { kind: "film", title: "Goodfellas", year: 1990 },
      { kind: "film", title: "Apocalypse Now", year: 1979 },
      { kind: "genre", title: "canonical heavyweights" },
      { kind: "genre", title: "cinema-as-syllabus" },
      { kind: "genre", title: "modernist mastery" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three provocateurs whose films land sharp without warm-up: David Cronenberg, Darren Aronofsky, Robert Eggers. Five films that already split the room: Mulholland Drive, Black Swan, The Lighthouse, mother!, Titane. Tags they live in: provocative oddities, art-house shock, festival darlings.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "director", title: "Darren Aronofsky" },
      { kind: "director", title: "Robert Eggers" },
      { kind: "film", title: "Mulholland Drive", year: 2001 },
      { kind: "film", title: "Black Swan", year: 2010 },
      { kind: "film", title: "The Lighthouse", year: 2019 },
      { kind: "film", title: "mother!", year: 2017 },
      { kind: "film", title: "Titane", year: 2021 },
      { kind: "genre", title: "provocative oddities" },
      { kind: "genre", title: "art-house shock" },
      { kind: "genre", title: "festival darlings" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who turn images into prayer: Terrence Malick, Denis Villeneuve, Hayao Miyazaki. Five films loved by big audiences for the way they look and feel: Arrival, Blade Runner 2049, Spirited Away, The Tree of Life, Interstellar. Tags they live in: transcendent visuals, spiritual cinema, dreamlike worlds.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Arrival", year: 2016 },
      { kind: "film", title: "Blade Runner 2049", year: 2017 },
      { kind: "film", title: "Spirited Away", year: 2001 },
      { kind: "film", title: "The Tree of Life", year: 2011 },
      { kind: "film", title: "Interstellar", year: 2014 },
      { kind: "genre", title: "transcendent visuals" },
      { kind: "genre", title: "spiritual cinema" },
      { kind: "genre", title: "dreamlike worlds" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors whose worlds open softly: Hayao Miyazaki, Pedro Almodóvar, Sofia Coppola. Five films audiences carry around long after the credits: Spirited Away, Lost in Translation, Past Lives, Aftersun, Talk to Her. Tags they live in: drifting wonder, luminous melancholy, soft surrealism.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Talk to Her", year: 2002 },
      { kind: "genre", title: "drifting wonder" },
      { kind: "genre", title: "luminous melancholy" },
      { kind: "genre", title: "soft surrealism" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors a Curator builds a room around: Wong Kar-wai, Park Chan-wook, Luca Guadagnino. Five widely seen films that double as visual moodboards: In the Mood for Love, Drive, Oldboy, Call Me by Your Name, Suspiria. Tags they live in: designed beauty, neon aesthetics, frame-as-painting.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Suspiria", year: 2018 },
      { kind: "genre", title: "designed beauty" },
      { kind: "genre", title: "neon aesthetics" },
      { kind: "genre", title: "frame-as-painting" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors whose films feel like long walks: Jim Jarmusch, Wim Wenders, Hirokazu Kore-eda. Five widely loved quiet ones: Paterson, Perfect Days, Wings of Desire, Only Lovers Left Alive, Drive My Car. Tags they live in: quiet wandering, minimalist drift, zen cinema.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Perfect Days", year: 2023 },
      { kind: "film", title: "Wings of Desire", year: 1987 },
      { kind: "film", title: "Only Lovers Left Alive", year: 2013 },
      { kind: "film", title: "Drive My Car", year: 2021 },
      { kind: "genre", title: "quiet wandering" },
      { kind: "genre", title: "minimalist drift" },
      { kind: "genre", title: "zen cinema" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who reliably go big and go tight: Christopher Nolan, Denis Villeneuve, David Fincher. Five widely seen films built like clockwork: Inception, Parasite, The Social Network, Dune, Whiplash. Tags they live in: prestige craft, smart blockbusters, tightly wound thrillers.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Inception", year: 2010 },
      { kind: "film", title: "Parasite", year: 2019 },
      { kind: "film", title: "The Social Network", year: 2010 },
      { kind: "film", title: "Dune", year: 2021 },
      { kind: "film", title: "Whiplash", year: 2014 },
      { kind: "genre", title: "prestige craft" },
      { kind: "genre", title: "smart blockbusters" },
      { kind: "genre", title: "tightly wound thrillers" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who hop genres without losing the craft: Steven Spielberg, Rian Johnson, Edgar Wright. Five widely loved Saturday-night picks: Knives Out, Catch Me If You Can, Hot Fuzz, Jojo Rabbit, Baby Driver. Tags they live in: genre-hopping, joyful craft, weekend-night gold.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Baby Driver", year: 2017 },
      { kind: "genre", title: "genre-hopping" },
      { kind: "genre", title: "joyful craft" },
      { kind: "genre", title: "weekend-night gold" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors a structuralist returns to: Akira Kurosawa, Quentin Tarantino, Sidney Lumet. Five universally recognised pieces of screenwriting craft: 12 Angry Men, The Godfather, Pulp Fiction, Seven Samurai, No Country for Old Men. Tags they live in: screenplay-first, classical canon, structural masterclass.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "The Godfather", year: 1972 },
      { kind: "film", title: "Pulp Fiction", year: 1994 },
      { kind: "film", title: "Seven Samurai", year: 1954 },
      { kind: "film", title: "No Country for Old Men", year: 2007 },
      { kind: "genre", title: "screenplay-first" },
      { kind: "genre", title: "classical canon" },
      { kind: "genre", title: "structural masterclass" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who quietly run the smart-genre lane: Michael Mann, Steven Soderbergh, Doug Liman. Five widely seen films where the craft does the work: Heat, Ocean's Eleven, The Bourne Identity, Mission: Impossible — Fallout, Logan. Tags they live in: tight action, professional crime, no-fat thrillers.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "genre", title: "tight action" },
      { kind: "genre", title: "professional crime" },
      { kind: "genre", title: "no-fat thrillers" },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors a fandom queues up for on opening night: Peter Jackson, James Gunn, J.J. Abrams. Five films that sit at the centre of huge audiences: The Lord of the Rings: The Fellowship of the Ring, Avengers: Endgame, Dune: Part Two, Guardians of the Galaxy, Spider-Man: No Way Home. Tags they live in: epic fandoms, shared-universe, binge-worthy worlds.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Guardians of the Galaxy", year: 2014 },
      { kind: "film", title: "Spider-Man: No Way Home", year: 2021 },
      { kind: "genre", title: "epic fandoms" },
      { kind: "genre", title: "shared-universe" },
      { kind: "genre", title: "binge-worthy worlds" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who never close the heart: Hayao Miyazaki, Greta Gerwig, Richard Linklater. Five widely loved films built for feeling: Before Sunrise, Lady Bird, Spirited Away, Past Lives, La La Land. Tags they live in: heart-on-sleeve, coming-of-age, tear-jerker.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Spirited Away", year: 2001 },
      { kind: "film", title: "Past Lives", year: 2023 },
      { kind: "film", title: "La La Land", year: 2016 },
      { kind: "genre", title: "heart-on-sleeve" },
      { kind: "genre", title: "coming-of-age" },
      { kind: "genre", title: "tear-jerker" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors with finishable, satisfying filmographies: Wes Anderson, Hayao Miyazaki, Christopher Nolan. Five universally seen films worth the rewatch: The Grand Budapest Hotel, Spirited Away, Inception, Pulp Fiction, No Country for Old Men. Tags they live in: completable canon, auteur boxsets, rewatch territory.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "film", title: "Pulp Fiction", year: 1994 },
      { kind: "film", title: "No Country for Old Men", year: 2007 },
      { kind: "genre", title: "completable canon" },
      { kind: "genre", title: "auteur boxsets" },
      { kind: "genre", title: "rewatch territory" },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "What They'd Love",
        body:
          "Three directors who deliver crowd-pleasers without insulting the crowd: Christopher McQuarrie, Greta Gerwig, Taika Waititi. Five widely seen films built for a relaxed evening: Top Gun: Maverick, Barbie, Mission: Impossible — Fallout, Knives Out, Spider-Man: Into the Spider-Verse. Tags they live in: saturday-night cinema, crowd-pleasers, popcorn-quality.",
      },
      {
        slug: "conclusion",
        title: "Conclusion",
    ...
    recommendations: [
      ...
      { kind: "genre", title: "saturday-night cinema" },
      { kind: "genre", title: "crowd-pleasers" },
      { kind: "genre", title: "popcorn-quality" },
    ],
  },
];
