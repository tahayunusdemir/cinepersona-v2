          ...
          <div className="flex snap-x snap-mandatory gap-3 overflow-x-auto pb-2 sm:grid sm:grid-cols-2 sm:gap-4 sm:overflow-visible lg:grid-cols-3">
            {hot.rows.map((t, i) => {
              ...
              <Link
                ...
                className="group relative block min-w-[260px] snap-start overflow-hidden rounded-2xl border bg-panel p-5 transition-all sm:min-w-0"
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {boards.map((b, i) => {
            ...
            <Link
              ...
              className="group relative block overflow-hidden rounded-2xl border bg-panel p-5 transition-all"
              style={{ borderColor: `${hue}30` }}
            >
              ...
              <p className="mt-4 inline-flex items-center gap-1 font-mono text-[10px] uppercase tracking-[0.22em] text-muted-foreground">
                Open board
                <ArrowRight
